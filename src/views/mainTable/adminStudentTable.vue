<template>
  <div>
    ...
    <!-- 书籍操作栏 -->
    <div style="padding: 10px 0">
      <el-button type="success" @click="setNewStudentVisible">新增 <i class="el-icon-circle-plus-outline"></i></el-button>
    </div>
    ...
    <el-table :data="tableData" border stripe>
      ...
      <el-table-column>
        <template slot-scope="scope">
          ...
          <el-button type="danger" @click="deleteStudent(scope.row)">删除 <i class="el-icon-reading"></i></el-button>
        </template>
      </el-table-column>
    </el-table>
