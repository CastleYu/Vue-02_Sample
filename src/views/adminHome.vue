      ...
      <el-main>
        ...
        <div style="padding: 10px 0">
          <el-input
            ...
            v-model="bookID"
          ></el-input>
          <el-button type="primary" @click="findOne" style="margin-right: 25px"
            >精确搜索</el-button
          >
        ...
        <!-- 书籍操作栏 -->
        <div style="padding: 10px 0">
          <el-button type="success" @click="setNewBookVisible"
        ...
        <modify-book
          :modify-book-visible.sync="modifyBookVisible"
          :b-data="cur_book"
        ></modify-book>
        ...
        <el-table :data="tableData" border stripe>
          ...
          <el-table-column>
            <template slot-scope="scope">
              <el-button type="warning" @click="setModifyBookVisible(scope.row)"
                >修改</el-button
              >
              <el-button type="danger" @click="deleteBook(scope.row)"
                >删除 <i class="el-icon-reading"></i
              ></el-button>
            </template>
          </el-table-column>
        </el-table>
