    ...
    <div style="margin: 150px auto; background-color: #fff; width: 350px; height: 400px; padding: 20px; border-radius: 10px">
      ...
      <el-form :model="user" :rules="rules" ref="userForm">
        <el-form-item prop="user_name">
          <el-input placeholder="请输入账号" size="medium" prefix-icon="el-icon-user" v-model="user.user_name"></el-input>
        </el-form-item>
        <el-form-item prop="user_pwd">
          <el-input placeholder="请输入密码" size="medium" prefix-icon="el-icon-lock" show-password v-model="user.user_pwd"></el-input>
        </el-form-item>
        ...
        <el-form-item prop="user_phone">
          <el-input placeholder="请输入电话号码" size="medium" prefix-icon="el-icon-phone" v-model="user.user_phone"></el-input>
        </el-form-item>
        <el-form-item prop="user_email">
          <el-input placeholder="请输入邮箱" size="medium" prefix-icon="el-icon-message" v-model="user.user_email"></el-input>
        </el-form-item>
