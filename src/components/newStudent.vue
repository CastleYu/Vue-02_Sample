    ...
    <el-dialog v-bind="$attrs" v-on="$listeners" @open="onOpen" @close="onClose" :show-close=false
        ...
        <el-form :rules="rules" ref="elForm" :model="studentData" size="medium" label-width="100px">
            <el-form-item label="名称" prop="user_name">
                <el-input v-model="studentData.user_name" placeholder="请输入账号名称" clearable
                    :style="{ width: '100%' }"></el-input>
            </el-form-item>
            <el-form-item label="密码" prop="user_pwd">
                <el-input show-password v-model="studentData.user_pwd" placeholder="请输入账号登录密码" clearable
                    :style="{ width: '100%' }">
                </el-input>
            </el-form-item>
            <el-form-item label="电话" prop="user_phone">
                <el-input v-model="studentData.user_phone" placeholder="请输入账号电话" clearable
                    :style="{ width: '100%' }"></el-input>
            </el-form-item>
